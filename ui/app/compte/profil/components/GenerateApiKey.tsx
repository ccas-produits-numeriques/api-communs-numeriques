...
export function GenerateApiKey() {
  ...
  const title = useMemo(() => {
    switch (statut) {
      case "none":
        return "Vous n’avez aucun jeton d’accès à API Communs numériques";
      case "actif-encrypted":
      case "actif-ready":
        return "Si vous avez besoin de jeton supplémentaires, vous pouvez en générer un nouveau";
      case "expired":
        return "Tous vos jetons d’accès à API Communs numériques sont expirés, vous pouvez en générer un nouveau";
      default:
