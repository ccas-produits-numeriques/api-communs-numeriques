...
Pour récupérer les secrets, vous devez avoir accès au vault 1password `ccas-vault-passwords-common`. Rapprochez vous de l'équipe transverse pour y avoir accès.
